...
export const sets: Set[] = [
  ...
  },
  {
    ...
    slug: "EXT./INT.",
    description:
      "Koi's corner of the Fish Market — spotless, precise, and always busy. Fresh rolls made to order, pride in every cut. The stall Kane tries to buy and cannot. The one place in the market that holds its ground without moving.",
