...
const creditLines: CreditLine[] = [
  ...
  { type: "name", text: "Thierry Dubois" },
  { type: "gap" },

  { type: "heading", text: "Produced By" },
  { type: "name", text: "DeShawn Williams" },
  { type: "name", text: "Mei Chen" },
  { type: "gap" },

  { type: "heading", text: "Executive Producers" },
  { type: "name", text: "Pierre Laurent" },
  { type: "name", text: "Rashad Moore" },
  { type: "name", text: "Aaliyah Davis" },
  { type: "gap" },

  { type: "heading", text: "Associate Producers" },
  { type: "name", text: "Kenji Tanaka" },
  { type: "name", text: "Priya Patel" },
  { type: "gap" },
  ...
  { type: "name", text: "Bayou Sound Studios" },
  { type: "name", text: "River Z Records" },
  { type: "gap" },

  { type: "heading", text: "Animation" },
  { type: "name", text: "Chen & Tanaka Animation" },
  { type: "gap" },

  { type: "heading", text: "Visual Development" },
  { type: "name", text: "Boudreaux Design Co." },
  { type: "name", text: "Fontenot Visuals" },
  { type: "gap" },

  { type: "heading", text: "Colour & Art Direction" },
  { type: "name", text: "Marie-Claire Boudreaux" },
  { type: "name", text: "Linh Nguyen" },
  { type: "gap" },

  { type: "heading", text: "Sound Design" },
  { type: "name", text: "Kwame Osei" },
  { type: "name", text: "Wei Zhang" },
  { type: "gap" },
  ...
  { type: "name", text: "Hana Kim" },
  { type: "name", text: "Yuki Nakamura" },
  { type: "gap" },

  { type: "heading", text: "Score" },
  { type: "name", text: "Jean-Marc Moreau" },
  { type: "gap" },
