...
const creditLines: CreditLine[] = [
  ...
  { type: "name", text: "Lorem Ipsum Dolor" },
  { type: "gap" },

  { type: "heading", text: "Produced By" },
  { type: "name", text: "Amet Consectetur" },
  { type: "name", text: "Adipiscing Elit" },
  { type: "gap" },
  ...
  { type: "role-name", role: "Louis", name: "Consectetur Adipiscing" },
  { type: "role-name", role: "Mama Sabine", name: "Elit Sed Do" },
  { type: "role-name", role: "Amara", name: "Eiusmod Tempor" },
  { type: "role-name", role: "Captain Beignet", name: "Incididunt Ut" },
  { type: "role-name", role: "Pants", name: "Labore Et Dolore" },
  { type: "role-name", role: "Ripple", name: "Magna Aliqua Enim" },
  { type: "role-name", role: "Marcus Vale", name: "Ad Minim Veniam" },
  { type: "role-name", role: "Victor Kane", name: "Quis Nostrud" },
  { type: "role-name", role: "Holly", name: "Exercitation Ullamco" },
  { type: "role-name", role: "Louis (singing)", name: "Laboris Nisi" },
  { type: "gap" },
  ...
  { type: "role-name", role: "Echo in the Water", name: "Ripple & Chorus" },
  ...
  { type: "role-name", role: "Stars Over the Block", name: "Holly & Ensemble" },
  { type: "role-name", role: "The Girl Who Pooped Her Pants", name: "Mama Sabine & Pants" },
  { type: "gap" },

  { type: "heading", text: "Music Production" },
  { type: "name", text: "Lorem Ipsum Studio" },
  { type: "name", text: "Dolor Sit Records" },
  { type: "gap" },

  { type: "heading", text: "Animation" },
  { type: "name", text: "Amet Consectetur Studio" },
  { type: "gap" },

  { type: "heading", text: "Visual Development" },
  { type: "name", text: "Adipiscing Elit Design" },
  { type: "name", text: "Sed Do Visuals" },
  { type: "gap" },

  { type: "heading", text: "Colour & Art Direction" },
  { type: "name", text: "Eiusmod Tempor" },
  { type: "gap" },

  { type: "heading", text: "Sound Design" },
  { type: "name", text: "Incididunt Ut Labore" },
  { type: "name", text: "Et Dolore Magna" },
  { type: "gap" },
