...
const creditLines: CreditLine[] = [
  ...
  { type: "name", text: "Leigh Akin" },
  { type: "name", text: "Neil Kaigh" },
  { type: "gap" },

  { type: "heading", text: "Directed By" },
  { type: "name", text: "Gale Nikin" },
  { type: "gap" },

  { type: "heading", text: "Produced By" },
  { type: "name", text: "Kai Glehn" },
  { type: "name", text: "Lena Kiagh" },
  { type: "gap" },

  { type: "heading", text: "Executive Producers" },
  { type: "name", text: "Hale Ginak" },
  { type: "name", text: "Nika Gehlin" },
  { type: "name", text: "Glen Haiki" },
  { type: "gap" },

  { type: "heading", text: "Associate Producers" },
  { type: "name", text: "Keila Gahn" },
  { type: "name", text: "Kian Gehl" },
  { type: "gap" },

  { type: "heading", text: "Voice Cast" },
  { type: "gap" },
  { type: "role-name", role: "Zuri",           name: "Naik Ghiel" },
  { type: "role-name", role: "Ade",            name: "Elin Khang" },
  { type: "role-name", role: "Louis",          name: "Gina Keihl" },
  { type: "role-name", role: "Mama Sabine",    name: "Haik Gline" },
  { type: "role-name", role: "Amara",          name: "Elian Kagh" },
  { type: "role-name", role: "Captain Beignet",name: "Kali Neigh" },
  { type: "role-name", role: "Pants",          name: "Higan Kale" },
  { type: "role-name", role: "Ripple",         name: "Gail Niken" },
  { type: "role-name", role: "Marcus Vale",    name: "Lian Khegi" },
  { type: "role-name", role: "Victor Kane",    name: "Ike Halign" },
  { type: "role-name", role: "Henchman",       name: "Anik Leigh" },
  { type: "role-name", role: "Holly",          name: "Kalen Ighi" },
  { type: "role-name", role: "Sushi",          name: "Nile Kaigh" },
  { type: "role-name", role: "J",              name: "Keila Nagh" },
  { type: "role-name", role: "Cedar",          name: "Gian Kheil" },
  { type: "role-name", role: "Sticks",         name: "Halign Ike" },
  { type: "role-name", role: "Chops",          name: "Nika Leigh" },
  { type: "role-name", role: "Bass",           name: "Kalig Nhei" },
  { type: "role-name", role: "Louis (singing)","name": "Kai Neigh" },
  { type: "gap" },
  ...
  { type: "name", text: "Nile Kaigh Studio" },
  { type: "name", text: "Glehn Akin Records" },
  { type: "gap" },

  { type: "heading", text: "Animation" },
  { type: "name", text: "Khaline & Ginak" },
  { type: "gap" },

  { type: "heading", text: "Visual Development" },
  { type: "name", text: "Elin Khang Design" },
  { type: "name", text: "Haile Ginkn Visuals" },
  { type: "gap" },

  { type: "heading", text: "Colour & Art Direction" },
  { type: "name", text: "Keila Gahn" },
  { type: "name", text: "Naik Ghiel" },
  { type: "gap" },

  { type: "heading", text: "Sound Design" },
  { type: "name", text: "Higan Kale" },
  { type: "name", text: "Glen Haiki" },
  { type: "gap" },
  ...
  { type: "name", text: "Gail Niken" },
  { type: "name", text: "Kali Neigh" },
  { type: "gap" },
