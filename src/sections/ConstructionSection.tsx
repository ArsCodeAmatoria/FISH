...
const ANIMAL_BEATS: Beat[] = [
  ...
  { scene: "Overheard",               chars: ["Captain Beignet", "Pants", "Sushi"],           location: "Fish Market", status: "written", description: "The trio overhear Sushi talking to a neighbouring vendor about what Kane really wants — the land, the location, the market brand without the people. The animals are on a rooftop, unseen. Captain goes quiet. Pants asks if he heard. He says: that's our market." },
