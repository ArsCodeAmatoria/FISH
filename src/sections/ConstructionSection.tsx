...
const ZURI_BEATS: Beat[] = [
  { scene: "Opening — The Arrival",       chars: ["Zuri", "Ade"],              location: "River / Docks",      status: "written", song: "Fish",                 description: "FISH plays over an aerial of Mama Amara drifting down River Z at dusk. Zuri stands at the bow, barefoot, watching the town appear. She hears a busker before the boat docks. She turns toward the sound. Ade ties up the lines. She follows the music. He doesn't notice." },
  { scene: "On the River — Fishing",      chars: ["Zuri", "Ade"],              location: "The River",          status: "tbw",                                   description: "Dawn. Zuri and Ade work the nets together on the river. She is good at this — fast hands, reading the current. They move in practiced silence. This is the one place they are easy with each other. The river is neutral ground. Music is not mentioned." },
  { scene: "The Market at Night",         chars: ["Zuri"],                     location: "Fish Market",        status: "written",                               description: "Zuri explores the lantern-lit market alone. She stops at every busker. She hums without realising it. Then catches herself and stops. She has been stopping herself for years." },
  { scene: "Louis and the Trumpet",       chars: ["Zuri", "Louis"],            location: "Market Square",      status: "written", song: "Trumpet",              description: "Louis plays trumpet. Zuri stops. He invites her to try. She refuses. He doesn't push. He just keeps playing. She stays and listens for twenty minutes. That is the whole scene." },
  { scene: "Before Sleep",                chars: ["Zuri", "Ade"],              location: "Mama Amara — Cabin", status: "written",                               description: "Zuri in the cabin, listening in secret to a recording of Amara singing. Ade knocks. She hides it fast. They talk about the fish yield. Everything important is left unsaid. This is their whole relationship in miniature." },
  { scene: "Louis — First Advice",        chars: ["Zuri", "Louis"],            location: "Market Square",      status: "tbw",                                   description: "Louis watches Zuri watching a busker instead of playing. He tells her: the hardest note is the first one. Everything after that is just remembering why you started. She says nothing. She thinks about it all day." },
  { scene: "Wheel of Groove",             chars: ["Zuri", "Louis"],            location: "Market Square",      status: "written", song: "Trumpet",              description: "Louis explains the Wheel of Groove — how rhythm connects all people across time. He says it has a next bearer. He doesn't say her name. She plays one note on the trumpet. Perfect. He grins." },
  { scene: "Mama Sabine's Shop",          chars: ["Zuri", "Mama Sabine"],      location: "Mama Sabine's Shop", status: "written", song: "Echo in the Water",    description: "Mama Sabine knows who Zuri is before she speaks. She takes Zuri to the river bank — not inside, outside, to the water's edge. She shows her something. Amara, standing on the bank in the last light before the storm. A vision, or a memory that doesn't belong to Zuri. Echo in the Water plays. Zuri stands very still." },
  { scene: "The Storm — Remembered",      chars: ["Zuri", "Amara"],            location: "The River",          status: "tbw",                                   description: "Fragment. Amara mid-concert on the dock stage. The storm arrives fast, the way river storms do. The river takes her. Nobody found her. The fragment ends. We are back with Zuri on the bank. Mama Sabine has not moved. The river is quiet." },
  { scene: "Zuri and Ade — The Rule",     chars: ["Zuri", "Ade"],              location: "Mama Amara — Cabin", status: "tbw",                                   description: "Zuri asks Ade — carefully, testing — if he ever misses music. He goes very still. He says: the boat needs caulking. He leaves. She watches him go. She understands now that the rule was never about her." },
  { scene: "Louis — Second Advice",       chars: ["Zuri", "Louis"],            location: "River Docks",        status: "tbw",                                   description: "Louis tells Zuri that grief is just love with nowhere to go. He says Ade is full of it. He says she is too. He says the only way through is sound. She asks: what if the sound makes it worse? He says: it can't make it worse than silence." },
  { scene: "Zuri Sings Alone",            chars: ["Zuri"],                     location: "Mama Amara — Cabin", status: "tbw",                                   description: "First time Zuri sings — alone in the dark cabin, quietly, her face to the porthole, to the river. Small. Private. Perfect. She doesn't know Ade is on the dock and can hear every word through the water." },
  { scene: "Ade Hears Her",               chars: ["Ade"],                      location: "River Docks",        status: "tbw",                                   description: "Ade stands on the dock and hears Zuri's voice coming across the water. He hears Amara. He puts his hand on the dock post and does not move for a long time. He does not go in. He does not stop her. This is already something." },
  { scene: "Ade Confrontation",           chars: ["Zuri", "Ade"],              location: "River Docks",        status: "tbw",                                   description: "Ade confronts her the next morning. He is not angry — he is terrified. The argument is about the singing but it is entirely about the river and what it took. Neither of them can say that yet. The scene ends without resolution. That is correct." },
  { scene: "Louis — Third Advice",        chars: ["Zuri", "Louis"],            location: "Market Square",      status: "tbw",                                   description: "Louis tells Zuri that her mother's voice still lives in the river. That when Zuri sings near the water, Amara hears her. He doesn't know if this is true. He says it anyway. It is the kindest thing anyone has said to her." },
  { scene: "Zuri Fishes Alone",           chars: ["Zuri"],                     location: "The River",          status: "tbw",                                   description: "Zuri takes the boat out alone before dawn. She fishes and hums. Then sings low, to the river. The river doesn't take her. It holds her. She understands something she can't name yet." },
  { scene: "Ade's Song",                  chars: ["Ade"],                      location: "Mama Amara — Cabin", status: "tbw",     song: "Quiet River",          description: "Ade alone at dusk. Quiet River. He blames music. He also knows the storm was the storm and not the song. He has never let himself reach that second thought. The song is the first time he does." },
  { scene: "Zuri Sings in Public",        chars: ["Zuri", "Ade", "Louis"],     location: "Dock Stage",         status: "tbw",     song: "Stars Over the Block", description: "Zuri sings in public for the first time. Unplanned, at the dock stage, to a small crowd. Ade hears it from the water. He rows toward the sound without thinking. He hears Amara. He hears Zuri. He hears that they are not the same person and the storm was not the music's fault." },
  { scene: "Ade Walks to the Stage",      chars: ["Zuri", "Ade"],              location: "Dock Stage",         status: "tbw",                                   description: "After the song. Ade ties up the boat. Walks to the stage. He doesn't say anything. He just stands there beside her. That is everything. The audience should feel it before they can name it." },
  { scene: "Fish Reprise",                chars: ["Zuri", "Ade", "Louis", "Sushi", "J"], location: "Fish Market", status: "tbw", song: "Fish (Reprise)",       description: "Full musical sequence. Every character. Zuri leads. Ade is in the crowd this time — watching, not leaving. The whole town is the chorus. The market is saved not by argument but by music. That is what the film was always about." },
];
...
const CHARACTER_ARCS = [
  ...
  { id: "ade",            name: "Ade",           want: "To keep music out of their lives", need: "To understand that the storm took Amara, not the song", arc: "Blame → Grief → Release", song: "Quiet River"                  },
          ...
          {activePage === "plot" && (
            <div className="mx-auto max-w-xl py-2 pb-16 space-y-8">
              ...
              <div>
                ...
                <p className="mb-4 text-[12px] leading-relaxed text-white/80" style={{ fontFamily: "var(--font-screenplay)" }}>
                  <strong className="font-semibold text-white/75">Amara</strong> was mid-concert on the dock stage when the storm came in off the river. Fast, the way river storms do. The river took her. Nobody found her. Ade was there. He has blamed music — not the storm — ever since. It is easier to blame something you can remove.
                </p>
                <p className="mb-4 text-[12px] leading-relaxed text-white/80" style={{ fontFamily: "var(--font-screenplay)" }}>
                  <strong className="font-semibold text-white/75">Zuri</strong> grew up with two passions: fishing and music. She kept the fishing. The music she hides — hummed in the cabin at night, listened to in secret on old recordings. She has her mother's voice and has never let anyone hear it. She doesn't know if she is protecting herself or her father.
                </p>
                <p className="mb-4 text-[12px] leading-relaxed text-white/80" style={{ fontFamily: "var(--font-screenplay)" }}>
                  <strong className="font-semibold text-white/75">Mama Sabine</strong> takes Zuri to the river bank — not inside, to the water's edge — and shows her Amara standing there in the last light before the storm. A vision. Echo in the Water. Zuri sees her mother as a person, not a silence. This is the turning point.
                </p>
                <p className="mb-4 text-[12px] leading-relaxed text-white/80" style={{ fontFamily: "var(--font-screenplay)" }}>
                  <strong className="font-semibold text-white/75">Louis</strong> gives Zuri three pieces of advice across the film, spaced far apart. Each one lands only when she is ready to hear it. He knows when to speak and when to just keep playing. He has been waiting for her since Amara died.
                </p>
                <p className="text-[12px] leading-relaxed text-white/80" style={{ fontFamily: "var(--font-screenplay)" }}>
                  When Zuri finally sings in public — unplanned, at the dock stage — Ade hears it from the river. He rows toward the sound without thinking. He hears Amara, then he hears Zuri, then he understands for the first time that they are not the same and the storm was not the music's fault. He ties up the boat. He walks to the stage. He stands beside her.
                </p>
              </div>
